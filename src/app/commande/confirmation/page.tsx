...
export default function OrderConfirmationPage({ searchParams }: { searchParams: { number?: string; discount?: string } }) {
  return (
    <div className="mx-auto max-w-2xl px-6 md:px-8 py-24 text-center">
      ...
      {searchParams.discount && (
        <p className="text-gold text-sm mb-8">Réduction appliquée : -{searchParams.discount} €</p>
      )}
      {!searchParams.discount && <div className="mb-10" />}
